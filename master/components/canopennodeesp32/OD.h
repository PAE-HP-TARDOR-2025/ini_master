...
********************************************************************************
    ...
    File info:
        ...
        Modified:     27/11/2025 13:42:42
        Modified By:  Janez Paternoster

    Device Info:
        Vendor Name:  -
        Vendor ID:    0
        Product Name: MasterNode
        Product ID:   1
...
typedef struct {
    ...
    uint16_t x1028_emergencyConsumerObject[OD_CNT_ARR_1028];
...
#define OD_ENTRY_H6200 &OD->list[44]
#define OD_ENTRY_H6401 &OD->list[45]
#define OD_ENTRY_H6411 &OD->list[46]
...
#define OD_ENTRY_H6200_writeDigitalOutput8_bit &OD->list[44]
#define OD_ENTRY_H6401_readAnalogInput16_bit &OD->list[45]
#define OD_ENTRY_H6411_writeAnalogOutput16_bit &OD->list[46]
